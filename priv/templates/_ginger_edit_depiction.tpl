{# Copy of the same template from 'zotonic_mod_driebit_edit', but with a different
## 'widget_class' and title for the upload dialog
#}
...
{% block widget_class %}c-edit__add-attachement{% endblock %}
