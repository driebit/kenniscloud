{% with not id or id.is_editable as is_editable %}
    <div class="row">
        <div class="form-group col-xs-12">
            ...
            <small class="helper-text">Dit stukje wordt getoond wanneer iemand met de muis boven je foto blijft staan.</small>
    ...
    <div class="row">
        <div class="form-group col-xs-12">
            ...
            <small class="helper-text">Hou dit kort en bondig.</small>
