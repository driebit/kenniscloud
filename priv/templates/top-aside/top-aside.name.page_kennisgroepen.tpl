...
{% endif %}
    <a href="/search?cat={{ m.rsc.acl_collaboration_group.id }}" class="c-btn--primary-no-icon c-btn--search">{_ Search for a knowledge group _}<img src="/lib/images/icon-font/--search.svg" class="c-btn--search__icon" /></a>