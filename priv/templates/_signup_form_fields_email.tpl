{# Copy of the same template from 'mod_signup' with the exception of the explicit
...
{% if show_signup_name_email %}
    <div class="form-group" id="signup_email">
        ...
        {% else %}
            ...
            {% validate id="email"
                type={email delegate="validator_base_email" failure_message=_"Enter a valid address"}
