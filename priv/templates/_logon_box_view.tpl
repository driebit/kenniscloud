{# This is a copy of a template from zotonic_mod_authentication #}
{# Title is removed as per the old site. Div with z-logon-box added on top of the form #}
{#
Params:
- page
- error_reason
...
<div class="z-logon-box{% if style_boxed %} z-logon-box-boxed{% endif %}" {% if style_width %}style="width: {{ style_width }};"{% endif %}>
